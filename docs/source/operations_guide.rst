...
To download the fabric-ca-client binary, browse to this  `repository <https://github.com/extrame/fabric-ca/releases>`_ and
...
this is the certificate of the admin that was signed and issued by the CA.
